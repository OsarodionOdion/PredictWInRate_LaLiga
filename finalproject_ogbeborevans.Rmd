...
ggplot(act_vs_pred_1718, aes(x = actual_season_points, y = predicted_season_points)) + geom_point() +
  ggtitle("Actual vs Predicted for La Liga 2017/2018 Season")

ggplot(act_vs_pred_1819, aes(x = actual_season_points, y = predicted_season_points)) + geom_point() +
  ggtitle("Actual vs Predicted for La Liga 2018/2019 Season")
