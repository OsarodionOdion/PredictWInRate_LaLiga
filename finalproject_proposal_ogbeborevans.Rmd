...
-----------------------
The data required for this project is a table consisting of different statistics for every game of the season. This data will be extracted from [Football-Data](https://www.football-data.co.uk/spainm.php)
